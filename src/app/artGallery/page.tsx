              ...
              <section className="mt-8">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  ...
                  <li>
                    ...
                    <p>
                      Have a specific vision in mind? Simply upload an image,
                      and our talented artists will create a custom painting
                      tailored to your preferences. Turn your memories into
                  ...
                  <li>
                    ...
                    <p>
                      Engage with artists directly by sending messages or
                      leaving comments on their artworks. Build meaningful
                      connections and support emerging talents within the art
                      community.
                    </p>
                  </li>
                  <li>
