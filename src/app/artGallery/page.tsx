          ...
          <section className="mt-8">
            ...
            <ul className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              <li>
                ...
                <p>
                  Shop with confidence knowing that all transactions are secure
                  and protected. Our streamlined checkout process ensures a
              ...
              <li>
                ...
                <p>
                  ...
                  our talented artists will create a custom painting tailored to
                  your preferences. Turn your memories into timeless
                  masterpieces!
                </p>
              </li>
              <li>
                ...
                <p>
                  ...
                  portfolios, and learn about their inspirations and techniques.
                </p>
              </li>
              <li>
                <h3 className="text-lg font-semibold mb-2">
              ...
              <li>
                ...
                <p>
                  ...
                  and browsing history. Discover new artists and artworks that
