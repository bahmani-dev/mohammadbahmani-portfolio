...
const Button = ({ text, type }: Props) => {
  return (
    <button
      type={type}
      className="relative inline-flex items-center justify-between  pl-5 py-6   transition duration-300 ease-out border-2  rounded-full shadow-md group  overflow-hidden font-medium        group  h-10 w-60    border-yellow-500     uppercase text-base"
    >
